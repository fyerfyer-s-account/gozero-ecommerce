...
func (m *defaultSkusModel) Insert(ctx context.Context, data *Skus) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ProductId, data.SkuCode, data.Attributes, data.Price, data.Sales)
	}, mallProductSkusIdKey, mallProductSkusSkuCodeKey)
	return ret, err
}
...
func (m *defaultSkusModel) Update(ctx context.Context, newData *Skus) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.ProductId, newData.SkuCode, newData.Attributes, newData.Price, newData.Sales, newData.Id)
	}, mallProductSkusIdKey, mallProductSkusSkuCodeKey)
	return err
}
