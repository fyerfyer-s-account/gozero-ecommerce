...
import (
    ...
    "github.com/fyerfyer/gozero-ecommerce/ecommerce/cart/rmq/internal/server"
...
var (
    configFile = flag.String("f", "etc/cart.yaml", "config file path")
...
func main() {
    ...
    // Start service group
    logger.Info(ctx, "Starting cart RMQ service...", map[string]interface{}{
        "listenOn": c.ListenOn,
    })
