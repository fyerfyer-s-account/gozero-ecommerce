...
func (_m *User) GetAddress(ctx context.Context, in *user.GetAddressRequest, opts ...grpc.CallOption) (*user.GetAddressResponse, error) {
	...
	var r0 *user.GetAddressResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *user.GetAddressRequest, ...grpc.CallOption) (*user.GetAddressResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *user.GetAddressRequest, ...grpc.CallOption) *user.GetAddressResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*user.GetAddressResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *user.GetAddressRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *User_Expecter) GetAddress(ctx interface{}, in interface{}, opts ...interface{}) *User_GetAddress_Call {
	return &User_GetAddress_Call{Call: _e.mock.On("GetAddress",
		append([]interface{}{ctx, in}, opts...)...)}
}
...
func (_c *User_GetAddress_Call) Run(run func(ctx context.Context, in *user.GetAddressRequest, opts ...grpc.CallOption)) *User_GetAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(*user.GetAddressRequest), variadicArgs...)
	})
	return _c
}
