...
import (
    ...
    "github.com/fyerfyer/gozero-ecommerce/ecommerce/message/rmq/internal/server"
...
var (
    configFile = flag.String("f", "etc/message.yaml", "config file path")
...
func main() {
    ...
    // Start service group
    logger.Info(ctx, "Starting message RMQ service...", map[string]interface{}{
        "listenOn": c.ListenOn,
    })
