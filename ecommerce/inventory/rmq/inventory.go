...
import (
	...
	"github.com/fyerfyer/gozero-ecommerce/ecommerce/inventory/rmq/internal/server"
...
var (
	configFile = flag.String("f", "etc/inventory.yaml", "config file path")
...
func main() {
	...
	// Start service group
	logger.Info(ctx, "Starting inventory RMQ service...", map[string]interface{}{
		"listenOn": c.ListenOn,
	})
