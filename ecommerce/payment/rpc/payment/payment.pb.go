...
type PaymentOrder struct {
	...
	Channel       int32                  `protobuf:"varint,5,opt,name=channel,proto3" json:"channel,omitempty"`                           // 1:微信 2:支付宝 3:余额
...
func (x *PaymentOrder) GetChannel() int32 {
	if x != nil {
		return x.Channel
	}
	return 0
...
func (x *PaymentChannel) GetChannel() int32 {
	if x != nil {
		return x.Channel
	}
	return 0
...
func (x *CreatePaymentRequest) GetChannel() int32 {
	if x != nil {
		return x.Channel
	}
	return 0
...
var file_payment_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x21,
	...
	0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
