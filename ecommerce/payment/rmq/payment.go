...
import (
    ...
    "github.com/fyerfyer/gozero-ecommerce/ecommerce/payment/rmq/internal/server"
...
var (
    configFile = flag.String("f", "etc/payment.yaml", "config file path")
...
func main() {
    ...
    // Start service group
    logger.Info(ctx, "Starting payment RMQ service...", map[string]interface{}{
        "listenOn": c.ListenOn,
    })
